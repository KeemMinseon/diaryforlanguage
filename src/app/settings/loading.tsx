  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 animate-pulse flex-col gap-6 px-4 py-6">
      <div className="flex items-center justify-between">
        ...
        <div className="h-5 w-12 rounded-sm bg-[var(--paper-line)]" />
        <div className="h-4 w-16 rounded-sm bg-transparent" />
      </div>

      <div className="h-14 w-full rounded-sm bg-[var(--paper-line)]" />
      <div className="h-14 w-full rounded-sm bg-[var(--paper-line)]" />
    </div>
  );
}
